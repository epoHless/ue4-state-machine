...
// Cross Module References
	FSMTEST_API UClass* Z_Construct_UClass_APlayerCharacter_NoRegister();
	FSMTEST_API UClass* Z_Construct_UClass_APlayerCharacter();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APlayerCharacter_Statics::NewProp_MovementSpeed = { "MovementSpeed", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APlayerCharacter, MovementSpeed), METADATA_PARAMS(Z_Construct_UClass_APlayerCharacter_Statics::NewProp_MovementSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APlayerCharacter_Statics::NewProp_MovementSpeed_MetaData)) };
	...
	IMPLEMENT_CLASS(APlayerCharacter, 2453653379);
	template<> FSMTEST_API UClass* StaticClass<APlayerCharacter>()
	{
		return APlayerCharacter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APlayerCharacter(Z_Construct_UClass_APlayerCharacter, &APlayerCharacter::StaticClass, TEXT("/Script/FSMTest"), TEXT("APlayerCharacter"), false, nullptr, nullptr, nullptr);
